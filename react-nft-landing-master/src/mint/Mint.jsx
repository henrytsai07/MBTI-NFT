  ...
  mint = async () => {
    ...
    if (window.ethereum && this.state.isConnected) {
      ...
      try{
        ...
        const response = await this.state.contract.mint(_mintAmount, {value: cost.mul(_mintAmount)})
  ...
  whiteListMint = async () => {
    if (window.ethereum && this.state.isConnected) {
      ...
      try{
        ...
        const response = await this.state.contract.whitelistMint(_mintAmount, Whitelist.getProofForAddress(this.state.user_address),  {value: cost.mul(_mintAmount)})
  ...
  mintButton = () =>{
    if(this.state.isWhiteListSale){
      if(Whitelist.contains(this.state.user_address)){
        ...
        return <p>You address is not in the whitelist, please wait for public sale</p>
      }
    }
      ...
      <div className="mint">
        <div className="container">
          ...
          <div id='wallet-address'>
              <label for="floatingInput">Wallet Address: {this.state.user_address}</label>
          </div>
          <div>
          ...
          <h5>Price {utils.formatEther(this.state.nftCost)} ETH each mint.</h5>
